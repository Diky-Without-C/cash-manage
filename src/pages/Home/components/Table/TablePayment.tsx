      ...
      {WEEKS.map((_, i) => {
        ...
        return (
          <td
            ...
            className={`${isPaymentComplete(payments) && "bg-green-600 text-white"} font-semibold text-lg relative cursor-pointer border text-center`}
          >
            {!isEditActive ? (
              ...
              <input
                ...
                className="input input-ghost absolute text-lg left-0 top-0 h-full w-full rounded-none bg-transparent text-center ring-inset ring-blue-500 focus:focus-within:outline-none focus:focus-within:ring-1"
              />
            )}
          </td>
        );
